...
//         const chunkData = await processChunkWithOpenRouter(chunkText, i);
...
//   const processChunkWithOpenRouter = async (chunkText, index) => {
//     try {
...
//         method: "POST",
//         headers: {
//           Authorization: `Bearer ${apiKey}`, // Replace with env variable in production
//           "HTTP-Referer": "https://your-site.com",
//           "X-Title": "Bank Parser App",
...
//       }
//     } catch (err) {
//       console.error(`OpenRouter failed on chunk ${index + 1}:`, err);
//       return [];
//     }
//   };
...
//           Upload Bank Statement (.pdf) To Open Route
//         </h2>
...
"""`;
      ...
      try {
        ...
        console.warn(`JSON parse failed on chunk ${index + 1}`);
        return [];
      }
    } catch (err) {
      console.error(`OpenRouter error on chunk ${index + 1}:`, err);
      return [];
    }
  };
